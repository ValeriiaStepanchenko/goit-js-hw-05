...
class StringBuilder { 
    ...
    get value() { 
        return this._value; //возвращает текущее значение поля _value
    }
    append(str) {
    ...
    pad(str) {
        this.append(str); //обязательно через this вызываем ф-цию
        this.prepend(str); //обязательно через this вызываем ф-цию
     }
}
